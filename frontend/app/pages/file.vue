  ...
  <div class="wrap">
    ...
    <div class="bottom-box">
      <div class="input-box">
        <div class="toolbar">
          <div class="left">
            <input @change="imgFileChange" ref="imgfile" type="file" multiple class="file" />
      ...
      <div class="image-box">
        <div class="images">
          <div v-for="item of state.files" class="doc">
...
<script setup>
  ...
  const submit = async () => {
    ...
    if (files.length > 0) {
      ...
      const res = await http.post('/api/client/file/upfile', formData, {
        headers: {
    ...
    state.status = '正在处理...'
    const url = config.public.BASE_URL + '/api/client/file'
...
<style scoped>
  ...
  .upimage {
    width: 100px;
    height: 36px;
    background: url('@/assets/images/up-file.png') no-repeat center center / 100% 100%;
    cursor: pointer;
  }
